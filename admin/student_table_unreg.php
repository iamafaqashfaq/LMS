	...
	<form action="delete_student.php" method="post">
		<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
			...
			<tbody>
				...
				<?php
				$query = mysqli_query($con,"select * from student LEFT JOIN class ON 
				student.class_id = class.class_id where status = 
				'Unregistered' ORDER BY student.student_id DESC") or die(mysqli_connect_error());
