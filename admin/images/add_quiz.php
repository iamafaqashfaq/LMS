						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								if (isset($_POST['save'])) {
									...
									mysqli_query($con,"insert into quiz (quiz_title,quiz_description,date_added,teacher_id) values('$quiz_title','$description',NOW(),'$session_id')") or die(mysqli_connect_error());
								?>
									<script>
