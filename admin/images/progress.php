                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                              		...
                              		<?php
										...
										order by fdatein DESC")or die(mysqli_connect_error());
                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										where teacher_class_id = '$get_id' order by class_quiz_id DESC ")or die(mysqli_connect_error());
										while($row = mysqli_fetch_array($query)){
										$id  = $row['class_quiz_id'];
										$quiz_id  = $row['quiz_id'];
										$quiz_time  = $row['quiz_time'];
									
										$query1 = mysqli_query($con,"select * from student_class_quiz where class_quiz_id = '$id' and student_id = '$session_id'")or die(mysqli_connect_error());
