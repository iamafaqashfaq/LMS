            ...
            <div class="row-fluid">
                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<select name="quiz_id">
											<option></option>
												<?php  $query = mysqli_query($con,"select * from quiz where teacher_id = '$session_id'")or die(mysqli_connect_error());
				...
				<tbody>
					<?php $query = mysqli_query($con,"select * from teacher_class
										...
										where teacher_id = '$session_id' and school_year = '$school_year' ")or die(mysqli_connect_error());
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											for($i=0; $i < $N; $i++)
											{
												mysqli_query($con,"insert into class_quiz (teacher_class_id,quiz_time,quiz_id) values('$id[$i]','$time','$quiz_id')")or die(mysqli_connect_error());
												mysqli_query($con,"insert into notification (teacher_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'student_quiz_list.php')")or die(mysqli_connect_error());
											} ?>
											<script>
