...
$query = mysqli_query($con,"select * from department where department_name = '$d' and dean = '$pi' ")or die(mysqli_connect_error());
...
mysqli_query($con,"insert into department (department_name,dean) values('$d','$pi')")or die(mysqli_connect_error());
?>
<script>
