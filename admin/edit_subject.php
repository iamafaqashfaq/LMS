						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysqli_query($con,"select * from subject where subject_id = '$get_id'")or die(mysqli_connect_error());
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" value="<?php echo $row['Credit_hour']; ?>" class="span1" name="Credit_hour" id="inputPassword" required>
											</div>
										</div>
										<div class="control-group">
										...
										mysqli_query($con,"update subject set subject_code = '$subject_code' ,
																		...
																		where subject_id = '$get_id' ")or die(mysqli_connect_error());
																		
										mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')")or die(mysqli_connect_error());
