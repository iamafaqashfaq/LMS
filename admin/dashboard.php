                    ...
                    <div id="block_bg" class="block">
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <?php
                                $query_reg_teacher =
                                    mysqli_query($con, "select * from teacher where teacher_status = 'Registered' ")
                                ...
                                <div class="span3">
                                    <div class="chart" 
                                    data-percent="<?php echo $count_reg_teacher; ?>">
                                    <?php echo $count_reg_teacher; ?></div>
                                ...
                                <?php
                                $query_student = mysqli_query($con,"select * from student where
                                 status='Registered'") or die(mysqli_connect_error());
                                ...
                                <?php
                                $query_student = mysqli_query($con,"select * from student")
                                 or die(mysqli_connect_error());
                                $count_student = mysqli_num_rows($query_student);
                                ?>
                                ...
                                <?php
                                $query_class = mysqli_query($con,"select * from class") 
                                or die(mysqli_connect_error());
                                ...
                                <?php
                                $query_file = mysqli_query($con,"select * from files") 
                                or die(mysqli_connect_error());
                                $count_file = mysqli_num_rows($query_file);
                                ?>

                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_file; ?>">
                                    <?php echo $count_file; ?></div>
                                ...
                                <?php
                                $query_subject = mysqli_query($con,"select * from subject")
                                 or die(mysqli_connect_error());
