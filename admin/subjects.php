	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="content">
				<div class="row-fluid">
					<a href="add_subject.php" class="btn btn-info"><i class="icon-plus-sign icon-large">
					</i> Add Subject</a>
					<!-- block -->
							...
							<div class="span12">
								<form action="delete_subject.php" method="post">
									...
									class="table" id="example">
										<a data-toggle="modal" href="#subject_delete" 
										id="delete" class="btn btn-danger" name="">
										...
										<tbody>
											...
											?>
												...
												<tr>
													...
													<td width="30">
														<a href="edit_subject.php<?php echo '?id=' . $id; ?>" 
														class="btn btn-success"><i class="icon-pencil"></i>
													 </a></td>
												</tr>
