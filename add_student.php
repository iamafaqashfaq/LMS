...
<body>
							...
							<div class="span12">
								...
								if (isset($_POST['submit'])) {
									...
									for ($b = 1; $b <=  $test; $b++) {
										...
										$query = mysqli_query($con, "select * from teacher_class_student where student_id = '$id' and teacher_class_id = '$class_id' ")
											or die(mysqli_connect_error());
	...
	if ($Add == 'Add') {
											...
											mysqli_query($con, "insert into teacher_class_student (student_id,teacher_class_id,teacher_id) values('$id','$class_id','$teacher_id') ") or
